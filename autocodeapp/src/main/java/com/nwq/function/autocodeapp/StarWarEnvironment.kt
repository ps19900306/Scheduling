...
//    }
    ...
    val isProtocolTasks by lazy {
        ...
        val list = mutableListOf<PointRule>()
        list.add(
            PointRule(CoordinatePoint(615, 382), ColorRuleRatioImpl.getSimple(254, 42, 64))
            // sequenceNumber:0 blockNumber: 0  positionType:2
        )
        val correctPositionModel = CorrectPositionModel(list, tag, 3, 3, false)
        val pointList = mutableListOf<IPR>()
        pointList.add(
            PointRule(CoordinatePoint(618, 387), ColorRuleRatioImpl.getSimple(255, 42, 64))
            // sequenceNumber:14 blockNumber: 0  positionType:2
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(615, 382),
                CoordinatePoint(611, 377),
                CompareDifferenceRuleImpl.getSimple(30, -10, 10)
            ) // sequenceNumber:0sequenceNumber blockNumber: $0  positionType:$0
        )
        ImgTaskImpl1(pointList, tag, correctPositionModel)
    }
    ...
    val isAgreementWeekTask by lazy {
        ...
        val pointList = mutableListOf<IPR>()
        pointList.add(
            PointRule(CoordinatePoint(1534, 827), ColorRuleRatioImpl.getSimple(254, 42, 64))
            // sequenceNumber:14 blockNumber: 0  positionType:2
        )
        FindImgTask(pr, findArea, pointList, tag)
    }
    ...
    val isAgreementChallengesClickTask by lazy {
        ...
        val pointList = mutableListOf<IPR>()
        pointList.add(
            PointRule(CoordinatePoint(1920, 478), ColorRuleRatioImpl.getSimple(213, 221, 224))
            // sequenceNumber:8 blockNumber: 0  positionType:2
        )
        pointList.add(
            PointRule(CoordinatePoint(1928, 479), ColorRuleRatioImpl.getSimple(209, 217, 220))
            // sequenceNumber:16 blockNumber: 0  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(1911, 486), ColorRuleRatioImpl.getSimple(206, 213, 219))
            // sequenceNumber:24 blockNumber: 0  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(1929, 485), ColorRuleRatioImpl.getSimple(205, 214, 219))
            // sequenceNumber:24 blockNumber: 0  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(1917, 487), ColorRuleRatioImpl.getSimple(190, 199, 204))
            // sequenceNumber:32 blockNumber: 0  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(1911, 482), ColorRuleRatioImpl.getSimple(202, 211, 216))
            // sequenceNumber:39 blockNumber: 0  positionType:1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(1920, 471),
                CoordinatePoint(1922, 471),
                CompareDifferenceRuleImpl.getSimple(30, 30, 30)
            ) // sequenceNumber:0sequenceNumber blockNumber: $0  positionType:$0
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(1928, 479),
                CoordinatePoint(1928, 477),
                CompareDifferenceRuleImpl.getSimple(30, 30, 30)
            ) // sequenceNumber:16sequenceNumber blockNumber: $0  positionType:$0
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(1911, 482),
                CoordinatePoint(1913, 482),
                CompareDifferenceRuleImpl.getSimple(20, 20, 20)
            ) // sequenceNumber:39sequenceNumber blockNumber: $0  positionType:$0
        )
        pointList.add(
            PointRule(CoordinatePoint(1910, 493), ColorRuleRatioImpl.getSimple(199, 208, 213))
            // sequenceNumber:0 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(1909, 494), ColorRuleRatioImpl.getSimple(190, 199, 204))
            // sequenceNumber:5 blockNumber: 1  positionType:1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(1910, 493),
                CoordinatePoint(1908, 492),
                CompareDifferenceRuleImpl.getSimple(30, 20, 20)
            ) // sequenceNumber:0sequenceNumber blockNumber: $1  positionType:$1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(1909, 494),
                CoordinatePoint(1907, 494),
                CompareDifferenceRuleImpl.getSimple(20, 20, 20)
            ) // sequenceNumber:5sequenceNumber blockNumber: $1  positionType:$1
        )
        pointList.add(
            PointRule(CoordinatePoint(1930, 492), ColorRuleRatioImpl.getSimple(193, 202, 209))
            // sequenceNumber:0 blockNumber: 2  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(1932, 494), ColorRuleRatioImpl.getSimple(201, 210, 219))
            // sequenceNumber:6 blockNumber: 2  positionType:1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(1930, 492),
                CoordinatePoint(1928, 492),
                CompareDifferenceRuleImpl.getSimple(20, 20, 20)
            ) // sequenceNumber:0sequenceNumber blockNumber: $2  positionType:$2
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(1932, 494),
                CoordinatePoint(1934, 494),
                CompareDifferenceRuleImpl.getSimple(20, 20, 20)
    ...
    val exitGame3Task by lazy {
        val tag = " exitGame3"
        val pr = PointRule(CoordinatePoint(866, 816), ColorRuleRatioImpl.getSimple(101, 101, 101))
        // sequenceNumber:0 blockNumber: 0  positionType:1
        val findArea = CoordinateArea(863, 764, 7, 135)
        val pointList = mutableListOf<IPR>()
        pointList.add(
            PointRule(CoordinatePoint(870, 821), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:8 blockNumber: 0  positionType:1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(870, 821),
                CoordinatePoint(872, 820),
                CompareDifferenceRuleImpl.getSimple(-30, -30, -30)
            ) // sequenceNumber:8sequenceNumber blockNumber: $0  positionType:$0
        )
        pointList.add(
            PointRule(CoordinatePoint(880, 817), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:0 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(880, 823), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:8 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(897, 817), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:16 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(880, 831), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:16 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(898, 823), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:24 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(884, 832), ColorRuleRatioImpl.getSimple(100, 100, 100))
            // sequenceNumber:24 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(888, 832), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:24 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(880, 846), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:32 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(885, 846), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:32 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(892, 832), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:32 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(888, 845), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:39 blockNumber: 1  positionType:1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(879, 838),
                CoordinatePoint(877, 838),
                CompareDifferenceRuleImpl.getSimple(-40, -40, -40)
            ) // sequenceNumber:24sequenceNumber blockNumber: $1  positionType:$1
        )
        pointList.add(
            PointRule(CoordinatePoint(864, 831), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:0 blockNumber: 2  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(868, 831), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:8 blockNumber: 2  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(867, 849), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:24 blockNumber: 2  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(869, 848), ColorRuleRatioImpl.getSimple(100, 100, 100))
            // sequenceNumber:24 blockNumber: 2  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(877, 853), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:32 blockNumber: 2  positionType:1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(869, 848),
                CoordinatePoint(869, 851),
                CompareDifferenceRuleImpl.getSimple(-40, -40, -40)
            ) // sequenceNumber:24sequenceNumber blockNumber: $2  positionType:$2
        )
        pointList.add(
            PointRule(CoordinatePoint(901, 836), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:0 blockNumber: 3  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(891, 840), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:8 blockNumber: 3  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(886, 837), ColorRuleRatioImpl.getSimple(101, 101, 101))
            // sequenceNumber:16 blockNumber: 3  positionType:1
        )
        pointList.add(
            TwoPointRule(
                CoordinatePoint(891, 840),
                CoordinatePoint(891, 838),
                CompareDifferenceRuleImpl.getSimple(-30, -30, -30)
            ) // sequenceNumber:8sequenceNumber blockNumber: $3  positionType:$3
        )
        FindImgTask(pr, findArea, pointList, tag).apply {
            clickArea = ClickArea(807, 774, 297, 115, false)
        }
    }
    ...
    val exitGameTask by lazy {
        MultiFindImgTask(arrayOf(exitGame3Task, exitGame2Task))
    }
    ...
    val isVegetableShipTask by lazy {
        ...
        val colorRule1 = OffWhiteFontColor
        val list = mutableListOf<PointRule>()
        list.add(
        ...
        val pointList = mutableListOf<IPR>()
        pointList.add(
            PointRule(CoordinatePoint(734, 150), colorRule1)
            // sequenceNumber:8 blockNumber: 0  positionType:0
        )
        pointList.add(
        ...
        pointList.add(
            PointRule(CoordinatePoint(742, 150), colorRule1)
            // sequenceNumber:16 blockNumber: 0  positionType:0
        )
        pointList.add(
        ...
        pointList.add(
            PointRule(CoordinatePoint(750, 150), colorRule1)
            // sequenceNumber:24 blockNumber: 0  positionType:0
        )
        pointList.add(
        ...
        pointList.add(
            PointRule(CoordinatePoint(737, 161), colorRule1)
            // sequenceNumber:8 blockNumber: 1  positionType:2
        )
        pointList.add(
            PointRule(CoordinatePoint(747, 160), colorRule1)
            // sequenceNumber:16 blockNumber: 1  positionType:1
        )
        pointList.add(
            PointRule(CoordinatePoint(737, 164), colorRule1)
            // sequenceNumber:16 blockNumber: 1  positionType:2
        )
        pointList.add(
    ...
    val isVegetableShip2Task by lazy {
        val tag = "isVegetableShip2"
        val colorRule1 = OffWhiteFontColor
        val list = mutableListOf<PointRule>()
        list.add(
        ...
        pointList.add(
            PointRule(CoordinatePoint(746, 162), colorRule1)
            // sequenceNumber:24 blockNumber: 0  positionType:0
        )
        pointList.add(
            PointRule(CoordinatePoint(739, 172), colorRule1)
        ...
        pointList.add(
            ...
            // sequenceNumber:31 blockNumber: 0  positionType:1
        )
        pointList.add(
            TwoPointRule(
    ...
    val isVegetableShipList by lazy {
        val offset = 422
        arrayOf(
            isVegetableShip2Task,
            isVegetableShip2Task.copyOffset("isVegetableShip1", offset, 0),
            isVegetableShip2Task.copyOffset("isVegetableShip2", offset * 2, 0),
            isVegetableShip2Task.copyOffset("isVegetableShip2", offset * 3, 0)
        )
    }
    ...
    val isTestOpenV2Task by lazy {
        val list = mutableListOf<PointRule>()
        val colorRule1=ColorRuleRatioImpl.getSimple(162,70,243,120,218,110,0.71098655F,0.51761657F,0.8289474F,0.5911243F,1.2641448F, 0.9649039F)
//        list.add(PointRule(CoordinatePoint(1908, 833), ColorRuleRatioImpl.getSimple(126,172,158))
//            // sequenceNumber:0 blockNumber: 0  positionType:0
//        )
        val correctPositionModel =CorrectPositionModel(list, "212", 3, 3, false)
        val pointList = mutableListOf<IPR>()
        ...
        ImgTaskImpl1(pointList, "212", correctPositionModel).apply {
    ...
    val isTestOpenTask by lazy {
        val tag = "isOpen"
        val list = mutableListOf<PointRule>()
        list.add(PointRule(CoordinatePoint(1901, 832), ColorRuleRatioImpl.getSimple(111,160,147))
            // sequenceNumber:0 blockNumber: 0  positionType:0
        )

        val colorRule1=ColorRuleRatioImpl.getSimple(162,80,243,140,218,130,0.71098655F,0.51761657F,0.8289474F,0.5911243F,1.2641448F, 0.9649039F)

        val correctPositionModel =CorrectPositionModel(list, tag, 3, 3, false)
        val pointList = mutableListOf<IPR>()
        pointList.add(PointRule(CoordinatePoint(1903, 833), ColorRuleRatioImpl.getSimple(151,223,208))
            // sequenceNumber:7 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1891, 835), ColorRuleRatioImpl.getSimple(137,209,187))
            // sequenceNumber:7 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1910, 833), ColorRuleRatioImpl.getSimple(151,224,204))
            // sequenceNumber:14 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1917, 835), ColorRuleRatioImpl.getSimple(144,218,201))
            // sequenceNumber:21 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1924, 837), ColorRuleRatioImpl.getSimple(155,232,202))
            // sequenceNumber:28 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1930, 841), ColorRuleRatioImpl.getSimple(135,202,188))
            // sequenceNumber:36 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1868, 851), ColorRuleRatioImpl.getSimple(136,205,188))
            // sequenceNumber:0 blockNumber: 1  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1866, 855), ColorRuleRatioImpl.getSimple(127,212,186))
            // sequenceNumber:7 blockNumber: 1  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1863, 862), ColorRuleRatioImpl.getSimple(120,190,173))
            // sequenceNumber:14 blockNumber: 1  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1949, 881), ColorRuleRatioImpl.getSimple(121,196,179))
            // sequenceNumber:18 blockNumber: 2  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1890, 835), ColorRuleRatioImpl.getSimple(121,179,164))
            // sequenceNumber:12 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1883, 838), ColorRuleRatioImpl.getSimple(126,180,170))
            // sequenceNumber:18 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1876, 843), ColorRuleRatioImpl.getSimple(129,192,170))
            // sequenceNumber:27 blockNumber: 0  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1890, 835), ColorRuleRatioImpl.getSimple(121,179,164))
            // sequenceNumber:12 blockNumber: 0  positionType:1
        )
        ...
        pointList.add(PointRule(CoordinatePoint(1948, 868), ColorRuleRatioImpl.getSimple(121,193,164))
            // sequenceNumber:6 blockNumber: 2  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1860, 869), ColorRuleRatioImpl.getSimple(119,185,164))
            // sequenceNumber:21 blockNumber: 1  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1859, 876), ColorRuleRatioImpl.getSimple(120,183,152))
            // sequenceNumber:28 blockNumber: 1  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1861, 887), ColorRuleRatioImpl.getSimple(113,192,168))
            // sequenceNumber:35 blockNumber: 1  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1862, 891), ColorRuleRatioImpl.getSimple(111,193,169))
            // sequenceNumber:43 blockNumber: 1  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1947, 864), ColorRuleRatioImpl.getSimple(118,183,161))
            // sequenceNumber:0 blockNumber: 2  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1949, 877), ColorRuleRatioImpl.getSimple(115,186,171))
            // sequenceNumber:12 blockNumber: 2  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1948, 887), ColorRuleRatioImpl.getSimple(116,185,165))
            // sequenceNumber:24 blockNumber: 2  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1945, 896), ColorRuleRatioImpl.getSimple(111,183,161))
            // sequenceNumber:30 blockNumber: 2  positionType:1
        )
        pointList.add(PointRule(CoordinatePoint(1905, 832), ColorRuleRatioImpl.getSimple(111,158,145))
            // sequenceNumber:6 blockNumber: 0  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1905, 832), ColorRuleRatioImpl.getSimple(111,158,145))
            // sequenceNumber:6 blockNumber: 0  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1936, 846), ColorRuleRatioImpl.getSimple(109,159,150))
            // sequenceNumber:0 blockNumber: 1  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1939, 850), ColorRuleRatioImpl.getSimple(106,160,148))
            // sequenceNumber:6 blockNumber: 1  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1944, 856), ColorRuleRatioImpl.getSimple(109,166,154))
            // sequenceNumber:12 blockNumber: 1  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1946, 862), ColorRuleRatioImpl.getSimple(106,162,153))
            // sequenceNumber:18 blockNumber: 1  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1860, 876), ColorRuleRatioImpl.getSimple(100,161,140))
            // sequenceNumber:8 blockNumber: 2  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1949, 875), ColorRuleRatioImpl.getSimple(100,166,144))
            // sequenceNumber:0 blockNumber: 3  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1949, 881), ColorRuleRatioImpl.getSimple(102,163,142))
            // sequenceNumber:8 blockNumber: 3  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1894, 833), ColorRuleRatioImpl.getSimple(108,156,144))
            // sequenceNumber:6 blockNumber: 0  positionType:0
        )
        ...
        pointList.add(PointRule(CoordinatePoint(1948, 870), ColorRuleRatioImpl.getSimple(94,155,137))
            // sequenceNumber:26 blockNumber: 1  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1860, 870), ColorRuleRatioImpl.getSimple(99,156,145))
            // sequenceNumber:0 blockNumber: 2  positionType:0
        )
        pointList.add(PointRule(CoordinatePoint(1948, 870), ColorRuleRatioImpl.getSimple(94,155,137))
            // sequenceNumber:26 blockNumber: 1  positionType:0
