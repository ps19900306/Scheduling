...
import com.nwq.function.corelib.utils.sp.SpConstant.FIGHT_MODEL
import com.nwq.function.corelib.utils.sp.SpConstant.NORMAL
...
class SPRepoPrefix(val prefix: String) {
    ...
    val wholeBattleListSP = SP(prefix + SpConstant.WHOLE_BATTLE_LIST, "[1,4,5,8]")
